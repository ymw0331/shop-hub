      ...
      <div className='container-fluid'>
        <div className='row'>
          ...
          <div className='col-md-9'>
            ...
            <CategoryForm 
            value={ name } setValue={ setName } handleSubmit={ handleSubmit } placeholder={ "Write category name" } />
            ...
            <Modal
              ...
              footer={ null }
            >
              <CategoryForm value={ name } setValue={ setName } handleSubmit={ handleSubmit } placeholder={ "Write category name" } />
